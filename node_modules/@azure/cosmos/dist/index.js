(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os-name'), require('tslib'), require('crypto'), require('uuid'), require('debug'), require('priorityqueuejs'), require('semaphore'), require('fast-json-stable-stringify'), require('jsbi'), require('node-abort-controller'), require('node-fetch')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os-name', 'tslib', 'crypto', 'uuid', 'debug', 'priorityqueuejs', 'semaphore', 'fast-json-stable-stringify', 'jsbi', 'node-abort-controller', 'node-fetch'], factory) :
    (global = global || self, factory((global.Microsoft = global.Microsoft || {}, global.Microsoft.Azure = global.Microsoft.Azure || {}, global.Microsoft.Azure.Cosmos = {}), global.osName, global.tslib_1, global.crypto, global.uuid, global.debugLib, global.PriorityQueue, global.semaphore, global.stableStringify, global.JSBI, global.AbortController, global.fetch));
}(this, (function (exports, osName, tslib, crypto, uuid, debugLib, PriorityQueue, semaphore, stableStringify, JSBI, AbortController, fetch) { 'use strict';
